...
<body>
    ...
    <main>
        <section id="paginaProduto">
            <div class="produto">
                <img src="./imagens/capas-livros-pi/Águas-de-Março-Vol-1/aguas-de-marco-1-capa-.webp">
                <div class="miniaturas">
                    <div class="carrossel-miniaturas">
                        <button class="seta-mini" id="miniAnterior">❮</button>
                        <div class="miniaturas" id="miniaturas">
                            <img class="thumb ativa"
                                src="./imagens/capas-livros-pi/Águas-de-Março-Vol-1/aguas-de-marco-1-capa-.webp">
                            <img class="thumb ativa" src="./imagens/capas-livros-pi/Águas-de-Março-Vol-1/livro.webp">
                            <img class="thumb ativa" src="./imagens/capas-livros-pi/Águas-de-Março-Vol-1/verso.webp">
                        </div>
            ...
            <div class="infos-produto">
                ...
                <div class="sinopse">
                    <p>"Em meio ao turbilhão carioca do início de verão, uma estadunidense desembarca, com um sonho nas
                        costas e a responsabilidade de fazer uma empresa florescer. Para Lizzie, o recomeço é parte
                        fundamental de uma nova fase de sua vida, e como o destino sempre lhe prega peças, ela nem
                        imagina que seu ponto de partida esteja mais perto do que nunca: um encontro inesperado com a
                        brasileira Carolina, uma jovem como ela nunca foi: livre e despreocupada, que, aos poucos,
                        começa a fazê-la entender que a vida é muito mais que apenas responsabilidades.
                        Uma relação surpreendente de caminhos entrelaçados.
                        O que parece ser apenas mais uma fase passageira se torna uma reviravolta no que Carolina e
                        Lizzie conhecem sobre amor e espiritualidade."</p>
                </div>
            </div>
            </div>
        </section>
