...
<head>
    ...
    <title>Almas Literárias - Mil Beijos de Garoto - Volume único</title>
...
<body>
    ...
    <main>
        <section id="paginaProduto">
            <div class="produto">
                <img src="./imagens/capas-livros-pi/mil-beijos-de-garotos/mil beijos.jpg">
                <div class="miniaturas">
                    <div class="carrossel-miniaturas">
                        <button class="seta-mini" id="miniAnterior">❮</button>
                        <div class="miniaturas" id="miniaturas">
                            <img class="thumb ativa" src="./imagens/capas-livros-pi/mil-beijos-de-garotos/mil beijos.jpg">
                            <img class="thumb" src="./imagens/capas-livros-pi/mil-beijos-de-garotos/livro.jpg">
                            <img class="thumb" src="./imagens/capas-livros-pi/mil-beijos-de-garotos/verso.jpg">
                        </div>
            ...
            <div class="infos-produto">
                <div class="descricao">
                    ...
                    <h2>Mil Beijos de Garoto - Volume único</h2>
                    <p>por: Tille Cole</p>
                </div>
                <div class="avaliacao">
                ...
                <div class="card-preco">
                    <p class="preco"><strong>R$ 49,89</strong></p>
                    <input type="number" placeholder="qtd" value="1">
                    <button class="add-to-cart">comprar</button>
                </div>
                <div class="sinopse">
                    <p>"Um beijo dura um instante. Mas mil beijos podem durar uma vida inteira. Um garoto. Uma
                        garota. Um vínculo que se prolonga por uma década. Um vínculo que nem o tempo nem a
                        distância podem romper. Quando, aos 17 anos, Rune Kristiansen retorna da Noruega à cidade
                        onde passou a infância (Blossom Grove, Geórgia), ele tem um único objetivo: reencontrar
                        Poppy Litchfield, a garota que prometeu esperar por ele. Ele quer descobrir por que, nos
                        dois anos que esteve fora, ela o deletou da vida sem explicações."</p>
                </div>
            </div>
            </div>
        </section>
