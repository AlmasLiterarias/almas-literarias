                                    ...
                                    <div class="row justify-content-around">
                                        <?php foreach ($grupoProdutos as $prod): ?>
                                            <div class="card col-md-3" style="width: 18rem;">
                                               <a href="../src/pages/livro.php?id=<?php echo $prod['id_produto']; ?>">
...
<?php if (empty($produtosDesktop)): ?>
    <p class="nadaEncontrado">Nenhum produto cadastrado no momento.</p>
<?php endif; ?>
        ...
        <section id="romances" class="py-5">
            <div class="container">
                ...
                $sql = "SELECT id_produto, nome_produto, img_produto, preco_produto, tipo_produto, idioma_produto 
                    FROM produtos 
                    WHERE romance_leve = 1
                    ORDER BY id_produto DESC 
                    LIMIT 12";
                        
                $sql = "SELECT id_produto, nome_produto, img_produto, preco_produto, tipo_produto, idioma_produto
        FROM produtos
        WHERE tipo_produto = 'romance_leve'
        ORDER BY id_produto DESC
        LIMIT 12";
